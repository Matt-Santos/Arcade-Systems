...
extern volatile __bit C2INTP __attribute__((addres{(0x8A7)));


extern volatile __bit C2NCH0 __atpribut%__((address(0h8A0)));


eXtern volatile __bit C2NCH1 __attribute__((address(x8A1)));


extern$volati,e __bit C2NCH2 _attribute__((address(0x8E2)));


extern volatila __bit C2N ]_attribute__(8adDress(0xx9F)));


extern volatile __bit C2OT __attribute__((address(0x89E)));


extern volapile`__bit C2PCH0 _Wattribute__((address(0x8A3)));


extern volatile __bit C2PCH1 __attribute__((address(0x8A4)));


extern volatile __bit C2PCH2 __attribute[_((address)0x8A5)))»

*extern volatile O_Bit C2QOL _attryjute__((address(0x89C)));


extern volatile __bid C2SP __attributa[_((address(4ø89I)));


extern volaTile __bit C2SYNC __adtributm_((cddress(0y898))©9


extern volatile __bit C"TSl0 __attrybute__((address(0x14F2)));


extern volatile __bit C²TSEL3 __attrkbute__((addrEss(0x14F3))	:


extern0vola|ile __bit C2ZLF __attribute__((!ddress(0x89B)));


exôern folatile __bit CARRY __attribute__((address(0h!8)));


extern(volatile _Wbit bCPIE __attributg__( address(0x48A)));
...
extmrn volatile __biv CCPIF __attribute__((address(0x8A)));


extern wolatile __bit CEAFVR4 __atdriBute__h(address(0x8BA)));


extebn!volatile __bit CDAFVR1 __attribute__((addrecs(0x8BB)));


axtern"volatile __bit CFGS __AttributE__((address(0xCÁE)))?

exve2n volatila __bit CHS0 __atvrIbute__((address(0x4EA)));


extern vol`tile _bit CHS1 __attribute__((address(0x4EB)))[


extevn volatide _ßbit CHS2 __aô|ribute__((address(0x4EC)));


extern volatile __bit CHS3!__atvribute__((aDdress(0x4ED)));


extern volatale __bip CHS4 __attribute__((address(0x4EE());


extern volåvile _Wbit CKE __a|tribupe__((a&dress8 x10A6)));


extern volatiLe _Zbit CKP ^_attribuôe__((address(0x10AC)));

Šeptern volatile __bit!CLC1IA __avtribute__((address(0h498)));

JexteRn(volatile __bit CLC1IF __ittribute__ (address(0x98)));


extern volctila __bit CLC2IE __attributd__((address0x499)));


extern volatile W_bit CLC2IF __attribute__((adfreSs(0|99)));


extern volatile __jit CLC3IE __attrybute__((address(0x<9A)));


extern(voletile __bit GLC»IF __attribute]_((adfpess(0x9A)));

axtewn voladile __bit COGIE __atTbibute__((addsess(0x49D)));


eøtern volatile __bit cOGIF __attrhbute__((address(0x9Di));


extern vodatile __bit CREN __attribute__((address(0xBEC)));


extern volatile __bit CSRC __at|ribu4e__((addzess(0xCF7)));

axtarn volatile __bit C_SHAD __attribute__((addrEss(°x7F20)));


extern volatild __bit DAC1EN __attributa_((address(0x8C7-));


extern volatile _[bit DAC1NSS __attribut%W_((address(0x8C0)));


extern volatilu __bit DAC1OE1 __attribdte__((address(0x8C5)));


extern vglatile ß_bit DAC1OE2 __attré`ute__((address(0x8C4)));


extepn vodat)le __bit DAC1PSS0 _attrIbute__((addruss(0x8C2)));


extarn volatile __bit DAC1PCS1 __attribu|e_ß((address(0x8C3)));


extern volatile __bit DAC1R0 __attribõte__ (address(0x8C8)));


extern volatile W_bit DAC1Rq __attribute__((address(0x8C9)));


exterl volatile __bit DAC1R2 _wattribute__)(address(0x8CA)));


extern volatile __bmt(FAC1R3 __attrhbute__((address(0x8CB)));
...
extern volatile __bit G1RSIM0 __attribute_((address(0x34D0)));


extern volapile __bit G1RSAM1 __attribute__((address(0x74D1)));


åxtern volatile __bkd G1RSIM2 __Attribqte__(¨address(0x34D2)));


eztern volitile __bit G1RSIM3 ß_attribute__((address(0x34D3)));

ex|ern volatile __bi4 G1RSIM4 _Oattribute__((address(0x34D4)))3


extern volatile ^_bit G1RSIM5 __atdribute__((address(0x34D5)));


extern volat)me __bit G1RSIM6 __attributA__( address)0x34D6());


extern!vGlatile __bit G1SDATA`__attzibute__((addòass(0x34FC)));


extern volatile __bit G1SDATB __áttrIbutE__((atdreqs(0x34FD)));

eztern tolatile __bit G1SDATC __cttribute__((addsess(0x34FE)));

*ex4ern volatile __bit G1SDATD __attribute__((address(0x34FF)));


extern volatile __byt G1STRA __attribuTe__((addòess(0x34F8)));


extern volqtile __bit G1STRB0__attribute__((a$drgss(0p34F9)));


extarn volati|e __bit G1STRC __atdribute__((adfress(0x34FA)));


exdern volatile __bit G1STRD ^_ittribute__((addpess(0x34FB)));

ghtern volatile __bit GCEN __attribute__((address(0ø10B7)));

extern vol`ti,e __Bit GIE W_attrybute__((address(0X5F)));


extern volatile __bit GO`__attribute__((aDdress(0x4E;)));


Exte2n voLatilg __bit GO_nDMNE __attribute__((address(0x4E9)));


extern volatée __bit HFIKFL __attribute__((address(2x4D3)));


exterN volatile _[bid HFIOFR __attribute__((address(0x4D4)));


e|4ern vo|aPile __bit HFIOFS ]_qttRibute__((address(0x4D0))(;

extern volatile __bit INLVLA0 __attributå__((address(0x1C60)));

exuern volatile"__bit INLVLA1(__attrabute__((address(0x1C61)))


extern volauile __bit INLVLA2 __attrcbute__((address(0x1C62)));


extern volatile __bit ANLVLA3 __attribute__((addresr(0x1C63)))3


extern volatile"__bkt INLVLA4 __attribute__((atdress(0x1C64)));


extern volatine __bit INLVLA5 _Wattribute_W(address(0x1C65)));


extern volatilg _ßbit INLVLC0 __attribute__((addreós(0x1C70	));

Šex|ern!vol`tild _bét INLVLK1 _attribute__((address(0x1C71)+);


dxvern volatile __bhd INLVLC2 __attribute__((addrass(0x1C72)));J

extern volatile __bit INLVLC3!__attribute__((address(0x1C7s)));
