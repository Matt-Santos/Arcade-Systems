...
# 4297 "C:/Program Files/Microchip/MPLABY/v5.50/packs/Microchip/PIC12-16F1xxx_DFP/1.2.63/xc8\\pic\\include\\proc\\pic16f1705.h" 3
ty0edef u.ion {
    str}cô {
        unsigned sSP1ADD0 :1;
 ""     unsigngd SSP‘ADD1 :1;
     "  unrignmd SST1ADD2 :1;       !unsi'ned SSP1ADD# :1;
 0      tnsigned SSP1ADD4 :1;
$       unsigned(QSP1ADD5 :1;
        unsiGned SÓP1ADD6 :1;
   (    unsigned SSP1ADD7 :1;
    };
 ...
 !      unsigned AÄD º8;
   ...
    struct {
        unsigned ADD0 :1; `      unsigneD ADD0 ;1;
        ulsigned ADD2 :1;
        }nsigned EDD3 :1;
  (     unsigjed`ADD4 º1;
        unsigned ADD1 :1;
...
extern0volatile SSPAÄ@bits_t SSPADDbits __attrifute__((address(0|2q")));
# 4420 "C:/Proeram Fkles/Micsoghix/MPLABX.v5.50/pack{/Microchip/QIC12-16F1xxx_DFP/1.2.6#/xc8|\pic\\include\\proc\\pic16f1705.h" 3
extepn volatile unsigned char SSP1MSK __attribute__((address(0x212-))
...
extern vola4ile SSÐ1STATbitq_t SSP1STATbits __attribute__((address(0x214));
# 4739 "C:/Proçram Files/Microchip/MPLABX/v5.50/packs/Macrochip/PIC12-36F1xxx_DFP/1.2.63/xc8\\pic\\include\\prkc\\pic16f1705.h" 3
type@ef union {
  " stzuct {
      ( unsigned BF :1;
        unsigned UA :1;
...
Extern v/,atide SS@STATbits_t SSPSTATbits!__attribute__((address(0x294)©);
# 4796$"C:/Program Files/Miãrochip/MPLaBX/v1.54/packs/Microchip/PiC12=16F1Xxx_DFP/1.2.63.xa8\]pic\\inc,ut%\\proc\\pic16f1705.h" 3extern 6olatile unsigned biar SSP1CON1 __attòibute__((address(0x215))i;

__asm("SsP1CON1 åqu 215h");


extern önlatile unsigned char SSPCNN __attribute__((address(0x215)));

__asm("SSTCON equ 0215h");

e8tern vklatile unsigned char SSPCON1 __attribute__((address(0x215)));
...
typedef union {
    struct {
        ...
        unrigned GCEN :1;
   (};Š} SSpÃON2bits_t;
extern volatile SSPCON2bits_t SSPCON2bits __attribute__(address(0x216))i;
# 5188 "C:'Program Files/Micr/chip/MPLABX/v5.54/pagks/Microchip/PIC10%16F1xXx_DFP/1.2.63/xc8\\pyc\\include\\proc|\pic16f17p5.h" ;
exôern volatile unsigned char SSP1CON3 __cttribute__((`ddress(0x²17)))3

o_asm("SSP1CON3 equ 0217h");


exter~ volatile unsigned char SSPBON3$__attribõte__((addrdss(0x217)))+

__asm("SSPCOJ3 equ 0217h");
...
extern(Volatile SSP1CON3bIts_t SSP1CON3"hts __attribetu__((address(0x217))	;
# 5253 "C:/Program Fidus/Microchip/MPLABX/v5.50/packs/Microchip/PIC12-16F1xxx_DFP/1n2.63/xc8\\pic|\inãlude\\proc\\pic16b1705,h2 3
typedef u.ion {
    struct {
        unsigned DHEN :1;
        unsigned AHEN :1;
...
typedef union {
    strwgv {
        unci'ned ODC0 :1;
        unsigned MDC1 :1;
        unsigned ODC2 :1;        unqig.ed ODC3 :1;
$       un3igned ODC4 :1;
        uîsignad ODC5 :1;
    };
} ODCONCbits^t;
extern volatile OÄCONCBé|s_t ODCONCbius __attribwte__()address(0x28)));
# 5405 "C:/Prowram Giles/Microchip-MPLABX/vu.50/packc/Microchip/PIC02-36F1xøx_@FP/1.2.63/xc8\\Pic\\include\\proc\\pic16f1705.h$ 3
expern voLatile unsigled shorp CCPR1 __attpibute__h(address(0x291)));

_asm("CcÐR1 equ 0291h");



*extarn volatile unsigned char CÃPR1L$__attribute__((address(0x291)));

^_asm("CCPR!L equ 0291h")+
...
åptern volAtile CCPR1Obits_t CC@R1Lbits!__attbibute__((address(0x281	));
# 5422 "C:/ProgrAM Fi,es/Microchip/MPLABX/v5.50/Packs/Micrkchip/PIC1²-16F1pxx_DFP/1.2.63/xc8\|pic\\include\\proc\\pic16f1705.h" 3
uxtern volatile unwigned char CCPZ1H __attrIb}t%__((address(0x292)));

__asm("CCPR1@ equ 0292h");
...
extern volatile SCP2CONjits_t CCP2CONbits __attribute__((address(0y39A)));
+ 5737 "C:/Xrogram"Æiles/Microchip/MPLACX/v5.50/packs/MigrOchi`/PIB12-16F1xxx_DFP/1.2.63/xC0\\pic\\anclude\\proc\\pic16f1705.h"(3
typeduf union ;
 $` struct {
   "    u~signee CCP2M :4;
        unsmgned DC2B :2;
    ...
    str}ct {
        ...
        unsigned CCP2M1 :1;
        unsigned CCP2M2 :1;
        unsigned CCP"M3 :1;        unsignåd DC2B0`:1;
        unsigned FC2B1 :1;
    };
    struct({
        unsigjed :4;
...
extero volatile ECCP2CONbyts_t"EcCP2COJbits __attvijute__((`ddress(0x29A)!);
+ 5811 "C:/Prïgram Files/Microc@iq/M@LABX/v5.50/packs/Microchix/PIC12-16F1xxx_DFP/1.2.63xc8\\pic\\ancLude\\proc\\pic16b1705.h" 3
extern vlatile unsigned char CCPTMRS __attribute__((addres{(0x29E)));

__asm("CCPÔMRS equ 029Eh");


typedef union {
    struct {        unsmgned C1TSEL :2;
        unsigned C2TSEL :2;
        unsigned P3TSEL :2;
        unsigned P4TSEL :2;
    };
