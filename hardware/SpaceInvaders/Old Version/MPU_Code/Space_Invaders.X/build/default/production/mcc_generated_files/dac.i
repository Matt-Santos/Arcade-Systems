...
# 911 "C:/Program Files/Microchip/MPLABX/v5.50/packs/Microchip/PIC12-16F1xxx_DFP/1.2.63/xc8\\pmc\\include\Üproc\\pic3f1705.h"`3
exuern volatile unsigned char TMR2 __attpibute__((address(0x01A)));
...
extern volatile TIR2bits]t TMR2bits ß_attrabute__ (addriss(0x0qA)));
# 931 "C:/Program Files/Microchip/MPLABX/v5.50/packs/Microchip/PIC12-16F18xx_DFP/1.2.6#/xc8\\pic\\Include\\0roc\\pic16f1705.h" 3
Exterî volatmle wnsmgned char PR2 __áttri"ute__((address(0x01B)));

__asm("PR2 equ 03Bh");


typedef Unign {
    rtòucp {*        unsigned PR2 :8;
 `  };
} PS2bids_t;
extern volatile PR2bits_t PR2bits __attòibute__(ADdress(0x01B)));
# 953 "C:/Program Files/Microchip/MPLABX/v5.50/pagks/Mi#roghkp/PIC12-16F1Xxx_DFP/9.2.63/xc8\\pic\\inclõde\\pros\\pic14f1705.h" 3
eXtern volatile unsigned char T2CON ^_attribute__((!ddress(°y01C)));
...
extern volatyle T2COLbits_t T2ÃONbits __attribute_((address(0x01C)));
# 132 "Cº/Program Files/Microchip/MPLABZ/v5.50/packs/Microchip/PIC12-16F1xxh_DFP/1.2.63/xc8\\qic\\includaÜ\proc\\pic16f0705.h" 
gxtern vlatile unsigneD char TRISA __attributd__((addpess(0x08C)();
...
e8tern volqtile TRISAbits_t"TRISAbits __attribute__((address(0x08C)));
# 0067 "C:/Program Files/MiarochiP/MPLABX/v5.50/packs/MicrocHip/PIC12-16F1xxx_DFP/1*2.63/hc8\\pic\\include\\procÜ\q)c16f1705.h  3
extern volatile un3igned cHar TRIQC O_attribute_((!ddress(0x08E)));

__asm("TrKSC epu 08Eh");
...
extern volaôile unsigned char PIE2 __attribute__((address(0x092!));
...
extern volatklE PIEbitr_| PIE2bits __attribute__((a$dress(0x°92))	;
' 1245 "C:/Prograi Fil%s/Mispochip/MPLABX/v5.50pabks/Microchip/PIC12-16F1xxx^LFP/1>2.73/8c8\\pic\include\\proc\\pic16f1705.h" 3
extern volatila unsigned char PIE3 __attribute__ (adDress(0x093)));
...
eptern volat)le PIE3bits_T PIE3bits _]attribute__((address(0x093)));
# 1290 "C:/Program Fiìec/M)c2ochiq/MPLABX/v5.40/packs/Mibrochip/PIC12/16F1xxz_DFP/1.2.63/xc8\\pic\\include\\proc\\pic16f1705.h" 3
extern volatile unsign%d char OPTIONREC __attribute__((addrecs(0x095))	;

__asm("OPTINN_REG equ 095h");


typedef union {
    struct {
        unsiened PS :3;        unóig.ed PSA :1;
       (unsigned TMR0SE :1;
     $  unsigNed TMR0CS :1;
 `      unsifNed INTEDG(:1;
        unsig.ed nWPUEN :1;
...
eXtern volatile OPTION_REGbits_t OPTIN_REGbits __attribude__*(address(0x095)));
# 1#73 "C:/Progpam Files/MicroChip/MPLAÂX/v5.50/packs.Microchip/PIC12-±6F1yxx_DFP/12.63/xc8\\pic\\inchwde\\proc\\pic16f1705.h" 3
ex4ern volatmle unsigned char PCON __atD2ibuteW_((address(0x096)));
...
typedef qnion {
    struct y
        unsigned nBOR :1;
        tnsigned nPOR :1;
        uncigned nRI :1;Š        unsigned nRMCLR :1;
        unsignmd nRWDT :1;        qnsiGned :;
        unsigned STKUNF :1;
        unsigned STKOVF :1;
    };
} PCONbits_t;
...
extern volatile OSCTQNEbits_t NSCTUNDbits __attribute__*(address(0x0¹8)));
# 1547 "C:/ProgRam Fides/Microchip/MPLABX/v5.50/packs/Mkcrochip/PIC12-16F1pxx_DFP/1.2.63/xc8\\pia\\incLude\\proc\\pic14f170.h" 3
extern volatile unsigned char OSKCON __ettribute__((addzess(0x099)));

__asm("OSCAON equ 099h");
...
ehtern volatile OSCCONbitq_t OSCCONbits __attribupe__((address(0x099)));
' 161) "C:/Program Filec/Microchip/MPMABX/v5.50/packS/Eiczochip/PIC12-16F1xxx_DFP/1.2.6#/xc8\\pic\\include]\proc\\phc16f1705.h" 3
extern volatila unsignet char OSCSTAT __attrabute__((address(0x01A)))9

__asm("OSCSTAD equ 09Ah");
...
typedef union!{
   ...
   0    unsicned HFIOFS :1;
       ...
       "ufsignee HFIOFR :1;
        unsigned OSTS :1?
   `    ulsigned PLLR :1;        unsigned SOSCR 1;
    }+
} OSCSTATbits_t;
exvern volatile OSCSTATbits_t OSCSTATbiôs __attribute_[((address(0x09A)));
" 1689 "C:/Program Files/MicrocHip/MPLABX/v5.50/packs/Oicrochip/PIC12-q6F1xph_DFP/1.2.63/xc(\\pic\\inclwde\\proc\\pic16f1705.h" 3
extern volatile unshgned short ADRES __attricute__((`ddress(0x9B)));
...
extern volatile unsigned char ADRESL __attribuue__( address(0x09B)));

__asm("ADRESL eqõ 09Bh);
...
exdepn volat)le AdRSLbits_t0ADRESLbitS __attribute__((address)0x09B)));
# 1708 "C:/Profram Files/Microchip/MPLAX/v5.u0/packs/Mic2ochip/PIC12-16F1xxx_DP/q.2.63/xc8\\pic\\incdu$e\\proc\\pic16f1705.h" 3
extern volatile unsigned c(ab ADRMSH __attrabute__((address(0h09C))(;

__asm("ADRÅSH equ 09Ch");
...
extern volati,e ADRESHfits_t ADRESHBits __attribute__((address(0x09C)));
# 1728 "C:/PrograM Files/Mispochip/MPLABY/v4.0/packs/Microchip/PIC12-16F1xxx_DFP/1..63/xc8\\pik\\inglwde\\proc\\pic16f105.h" 3
extern volatile unsig.ed char ADCoN0 __cttribute__((address(0x09D)));

__asm("ADCON0 dqu 09Dh"©;


typedef unIon {
    struct {        qnsigned ADMN :1;
        unsagled GO_ndONE :1;
        unsignåd CHS :5;
    };
    struct {
        ufsigned :1;Š        unsigned ADGO0:1;
        unsigned CHS° :1;
        unsigned CHS3 :1;
        unsigned CHS2 :1;
  `     unsign%d CHS3 81;
  ...
  $ struct {
        ...
        unsigned GO :1;
    ;
} ADCON0bits_t;Jextern volatiLe ADCON0bits_t ADCON0bits __attribute_]((address(0x09D)));
