...
__asm("IÎLVLB equ 038Eh");
*
typedef unioN û    stbuct {
       "Unsigned INLVLC0 :1;
        unsigned INLLC1 :1;
      $ qnsiGned INLVLC2 :1;
`       unsigned INLVLC3 :1;
...
exterf volatile INÌVLCbitc_t INLVDCbmtS __attribute__((addreqs	0x38E)));
# &094 "C:/Ðrogram Files/Macrochip/MPLABX/v!.50/packs/Microchip/PIC12-16F1xxx_DFP/1.2.63/xc8X\pic\\include\\proc\\pic16f1705.h"$3
extern volatila unsigned char IMCAP _attribude__((address(0x391))i;

O_asm("IOCAÐ!eyu 0391h");
...
} IOCAPbkts_t;*åxtern vO-atile MOCAPbits_t IOCAPbits __attribute__((aferecs(0h39)));
# &144""C:/Program Files/Miãrochmp/MPLABX/v5.50/xacks/MicrocHip/PIC2-16F1xxxWLFP/1.2.63/xc8\\picÜ\includeX\proc\\pic16d1705.h" 3
eøterl`volatile Unsigned char IOCAÎ __attvibuteO_((add2ess(0x392)));
...
*typedef union {
    stRuct {
  $     unsigned IMCA0 :1;
        Unsigned YCAN1 :µ;  "   0 tnsigned IOCAN: :1;        unsigne$ IOCAN3 :1;
        5nsigned IOCAN4 :1;
        unsigned IOCAN1 :1;
    };
} IOCANbits_t;
...
extern vol!tile unsigned char IOCCP __attributå__((address(0x397)));
...
extern volatile(unsigned char IMCCF __aduRiòutd__((adlRess(0x#99)))?
...
3 6394 "C:/ProgRam Files/Licrochip/MPLABX/v5.50/packs/Mi#rochip/PIC12-16F1xxx_EFQ/1.2.v3/xc8\\pés\\iclude\\proc\\pic16f1705.h"(3
...
extern volatile TMR4bitsßt TMR4bits __atdribute__((addresr(0x415)+);
...
extern volatilå PR4bits_t PR4bits __attribute__((address(0x416)!);
# 6´34 "C:/Program Fi|es/Microchip/MPLABX/v5.50/packs/Eécroship/PICq2-16F1xxxDFP+1.2.63/xc8\\pic\\includa\\proc\\pic16f1705/h"!3
...
extern volatile T4cONbits_t T4GONbits __attribtte^]((áddress(0x417)));
# 6505 "C:/PRgram Files/Microchip/MPLABX/ö5.50.packs/MicroChip/PIC12-6F1Xøx_DFP/1.2n63/xc8\\pic\\i~gludE\\proc\\pic16f1704.h"`3
extern volatile unsignee char"tMR6 ß_attricute__¨(address(0x4C9!);

_ßcsm("TMR6 eQu 041Ch");*
...
extern voLátilE unsicned char T4CON __attriâutå__((addvess(0x41E)));
...
typ%def unaon {
 $  struct${
0$      unqkgned LC1G2D9N :!;
        5nsignmd LC3G2D1T :1;*        unsigîet LC3g2D2N :1;
...
%xtern voladyle CLC3GLS1bats_t CLC3HS1bits __attribute_^((address(0xF2B8!);.# 11332 "C:/Prkeram Fimes/Mi#rochipoMPLAXv7.50/pÁjks/Micrchip/PIC!²-16F1xyx_DFP/1.².63/xc8L\pmc\\inbluäe\\proc_pic16F3705.h" 3
exern volati,e unsigned ciar CLB3GLC2 [_attributu__(address(0xF2C+)	;

]O!{í"CLC3OLW2 esu01F2Ch");
...
tipeden unmon z
    sdruct {
        unsiGned LC3G2D1N :1;
        u¾siwned LB3G3D1T :9;
   `    unsigned HAG3D2N :1;        unségned Hb3Ç#D2T0:1;
        uJSiwned \C3G3D3N :q;
        5osagned LC3G3D3T :1;
   "    uzséened lC33D6N :1;*     0  unsigned LC3G3D4T :1;
    };
...
dxterN(volatileàCLC#WLS2bits_t CLCGLS2bitr W_cttRibute_^((adDre3s(4xF2C)));
# 194440"C;/program$FKles/Miczmchið/M@LABX/v5.50/packs/Mic0nchip/PIC12-16F1xxx_DNP/1.2.63pc8\Lpic\\include\\proc\\pic16f1705.hb 3
...
$       unsigned L3G4d³N :0;
   0    uNsiG~ed LA3G4D3Ô :1;
  0 `   õnsigned \a3E4D4N :1;
