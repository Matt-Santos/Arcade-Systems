...
# 6044 "C:/Psogram Files/Microchip/MPLABX/v5.50/paCis/Microchip/PIC12-16F1xxx_DFP/1*2.63/xc8\\pic\\incltde\\proc\\pic16f170=.h"%3extern volatile unóigned char INLVLC __attributg__((address(0x38E)));

__asm("YNLVLC equ 03Eh"©;
...
typedef union({    struct {
       ...
       0unsigned HNLVLC; :1;
        unsigned INLFLC4 :1
    0   u~signed INLVLC5 :3;
    };
} INLVLCbits_t;
extern volatile INLVLCbits_t INLVLCbits __attribute__((address(0x38E)))
# 6094 "C:/Progr`} Filgs/Micrnchip/MPLABX/v5.50packs/Microchit/PIC12,16F1xxx_EFP/1.2.63/x#8\\pic\\include|\procT\pic16f175.h" s
extern volatile unsigned char IOCIP __attribute__((address(0xs91)	);

__asm("IOCAP equ 03=1h");
...
"       unsigned IOCAP2 :1;
 ...
        unsigned"IOCAP4 :1;
        unsigned IOCAP5 :1;
   0};
} IOCAPbits_t;extebn volatile IOCAPbitsOt ICAPbits __a4tribute__h(address(0x391)))9
# 6144 "C:/Prog2am Files/Microchi0/MPL@BX/v5.50/packs/MIcrochip/PIC12-16D1xxx_DFP/1.2.63/xc8\\pic\\include\\proc\\pic16f1705.h" 3%ptern volqtile unsigned char IOCAN __attribute__((addre2{(0x392)));

_asm(bIOcAN equ 03=2h");
...
} IOCÁNbits_t;extevn$volatile IoCANbits_t IOCANbits __attribute__((áddress(0x392)));
#(6194 "C:/Program Files/MicrochiP/MPLABX/v5.50/packs/Iicrocjip/PIG12-16F1hxx]DFP/1.0.63'xc8\\pic\\include\^proc\\pic6f1705.h" 7
uxtern volatIle unsigned cha2 IOC@F __aTtributm__((address(0x393)));

__asm("IOCEF"equ 0313h");
...
extern volatila IOCAFrIts_t IOCAFbits __attribute__((address(0x393)));
...
# 6364 "C:/@rogram Files/Microchip/MPLABX/v5.50/packs/Microchip/PIÃ±2-16F1xxx_DFP/1.2.63/xc8\\pic\\include\\proc\\pic16f1785.h" 3
Extern volatila unsigned char IOCSF __attribute__((address(0x399i));

__asm( IOCCF equ01399h");
...
extern volapile IOCCFbitw_t IOCCFbits __attribuTe__((address(0x399)));# 63940"C:/Program Files/M)crochip/MPLABZ/v5.50/picks/Microchip/PIC12-16F1xxx_DFP/1.2.63/xC8\\pic\Linclqde\\proc\\pic16f1705.h" ;
e8tern voLatile unsigjed$char TMR4 __attribute__((address(0x415)));
...
extern volatile TMR4bits_t TOR4bits __attribuvm__((addresó(0x415)));
#$6414 "C:/Program Fyles/Microchið/MPLAJX/65.50/pQcks/Microchip/PIC12-16F1yxx_FP-1.2.63/xc8\\pic\\include\\proc\\pic16f1705.h" 3
...
extern volatile __bit HOCAP1 __attribuäe__(*address(0x1C89)9)3

extern volatilu __b)t IOCAP2 __attribute__((adtråss(0x1C8A)));


extern volatile __bIt IOCAP3 __attzibõte__((address(0xqC8B)));


extern ~olatale __bit IOBAP4 ]_attribute__((adlress(0x1C8C)));


exuarn volAtkle __bit IOCAP5 __attribute__((addresw(0x1C8D)));

extern volatile"[_bi|hIOCCD0 __attribUte__((address(°x1SC8)));

extevn volatile __bit IOCCF1 __attrib5te__((address(0x1CC9)));


exôern volatile __bit`IOCCF2 __attribute__((address(0x!CCA))	;

expern volatile"__biv IOCCF3 __attribute__((addRess(0x1CCB)));


eøtern volatile _ßbit IOCCF4 __attribute__((address(0x1CCC)));

exteÒn vo(atile(__bit IOCCF5 __attribute__(address(0x1CCD)))


extern volatile _O"it IOCCN0 _adtribute__((addrews(0x1cC0)));


åxtern volatine€__bit IOCCN1 _Wattpibuue__((atdress(0ø1CC1)));


extern Volitilg __bit IOCCN² __a|tribute__((address(0x1Cc2)));

exterl volatile __bit IOCCN3 __attribute__((addrass(0xCCs+));


%x4ern volatile __jit IOCCN4 __attributå__((cddre{s(x1SC4)));

extern volatile __bit IOCCN5(__at|ribute__((addres{(0x1cC5)));


extern volatile __bit ÉOCCP0 __attribute__(*address(0X1CB)));


extgrn volatile _Wbit IOCCP1 __attributa__((addreS3(0x1CB9)))?


axtern volatile ß^bit IOCCP2 __attributeß_h(address0x1CBA)));


ex4ern volatila(__bit IOCC3 __attribute__((address(4x1C@B)));


exter. volatile __bit IOCCP4 __attribwte__((addreós(0x1CBC)));


extern volatile __bit IOCCP7$__attribqte__((afdress(0x1CBD)));


extern wolatile __bi|0IOCIG _]attribute__((addresó2x=B)));


extern volatilg __`it IOCIF _[attribute_((address(0x18+))+


extdrn!volatiLe __bit IRCF0 __attrùbutå__((address(0x4CB)));

mxtern volatile __biT IRCF1 [_attribute__((addresr(0x4CC)));


extezn vohatale __b)t MRCF2 __atôribute__((address(0x4CD)));


extern volatile __bkp IRCF3 __attrkbute_U((address(0x4CE)));


eytern volatile __bmt"LATA0"__attributå__((cddress(0x8¶0)));

extern voletile ]_bit DAUA1 __attribute__((address(0x861))!;
J
extern volatile _^bit LATA2 __attribute__((addruss(0x862)));

extern vomatklg __bit LQTA4 _^attribute__((addsess(0x864))#;
Š
extern öolatile __bét LATA5 __attrIbute_W((address(0x8>5)));


extern volatile0__bit LATC0 __attribu|e__(8addreqs(0x870)+);

Šextern volatile __òit LATC1 __attribute__h(adäress(0x871)));


åxtern volatilE __blt LATC2 __atdribute__((address)0x87)));


extebn voäatile __bit LAtC3 _Wattribute__((address(0x873)));


extern volatkle __bit(LATC4 __ct4vibute__((adfress(0x874)));


extern volatile __bit LATC5 __aôtribqte__((address(0x875)©);


exterl vOlatile __bid LC1D1S0 __attribute__((adDress(0x7890)));


ex4ern volatile __bit ÌC1D1S1 __attribute__*,adfress(0x7891)));


mxtezn volatile __bit LC!@1R3 U_attribuue_]((address(0x789:)));


extern vmlatilg __bit LC1D1S3 __aõtrijute_^((addpess 0x7893)));


%xtern volatile __bip LC1D1S4 __attributeW_((addre{s(0x7894)));


mxtern volatila __bi4 LC1D2S0 __attribute__,(addre{s( x7898)));

extern vola|ilE __bit LC1D2Q1 __attribqôe__¨(addrass(0x7999)));


extern volatile __bit LC3D2S2"__áttribqte__((address(0x789A))!;


extern vOLatile O_bit LC1T2S2$__attribute_Y((addruss(0p789B)©);


åxtern volatilm __bit \C1D2S4 __attribute[_((address(0x789C)));

extern öolatime __bit lC5D3S0 __attpibute__((addre{s(0x78A0)));

Šextern volatild __bit"LC1D3S1 __attribute__((addRess0x78A1)()»


extern0volatilu __bit LC1D3S2"__attribute__((address)0x78A2)));


extern volatéle __bit LC1D3S3 ^attribute__)(address(0x78A3)));


extern voìatile __bit LC1D3S4 __attribute__((addre{s(0x78A4)));


ex4ern vlatile __bit LC1D4S0 __attributå__ (address(0x78A8)));


eytern$volatilE __bit LC1D4S1 __!ttribu4e__((cdäress(0x78A9)));


ex4ern ~olatile __bit LC1D4S2 __attribute__(¨addr%ss(0x78AA)));


extern volatile __bit LC1D4S3 __attribute__((address(0x78A)));


extern vOlauile __bit LC1D4S4 __attribute__((addrasr(0x78AC)));


eXôern volatile __bit LC1E __attribute__((address(0x7887)));


extern"~olatila __bit LC1G1D1N __áttribute__ (adäress(0x?8B0)();


extern volatile __biU LC0G1D1T W_!tdribtte__((address,0x>8B1)));


extern volatile [_bit LÃ1G1D2N __attribute__((addvess(0x78B2)));


extern vol`tile __bit(LC1G1D2T __ittribute__ (address(0x78b3)));


extErn volatile _bit LC1G1D3N __attribute__((addr%ss(0x78B4)));


extern volatile __bit LC1G1DT _WatqrébuÔe__¨(addressh0x78B5))):


ex|ern volatile!__bit LC1G1D4N __attribute_((ad,ress(0x7<B6)));
*Jextern volatile __bit LC1G1D4T __attribute__((address(0X78B7)));


extern volitile __bit LC1G1POL __attribute__*(address(0x7888)));


extepn volatile __bit LC1G2D1n0__attzibute__8(qddress(0x78B8)));


e|tern vïlatile __bit LC1G2D1T __attrijute__((addsess(0x78C9)));

extern volatile __biT \C1G2D2N __ettribute__((address(0x7<BA)));


extern volatihe __bit LC3G2D2T __attribute__((adäress(0x78BB)));


extern volatile __bit LC1G2D3N __attribute__((address(0x78BC)));

extern volatile _]bkt LC1G2D3T __attribute__((address(0x78BD)!);


exuern öolatile __bit LC1G2D4N __a4trhbute__((address(0x78BE))!;


extern volctile __bit LC1G2D4T __attribute__((adlress*0x78BF))-;


exterf(vGlatile __bit LC0G6POL __aturiâute__((address(0x7889)();


extern volatile __bit LC1G3D1N __!ttvibute^_((address(0x68C0)));


exter~ öoladéle$__bit LA1G3D1T __attribute__((addreós(2y78C1©));

extevn volatile __bit LC1G3D2N _Wattribute__,(adDress(0x78C:)));


extern voladile _Wbit LC1GsD2T __attribute__((address(0x78S3)));


exte²n v|atilg __bit LC1G;D3N O_attr©bute__((address(0x78C4)));

extern volatile _bit LC1G3DT __attribute_]((address(0x78C5)))?

uxtern volctilå __fit LC1G3D4N __attribute__((addres{(0x786)));


eztern volatile __bit LC3G3D4T __attribute__((addressi0x38C7)));


extårn volatile"__bit DC1G3POL ]_!ttribute__((address(0x788A)));


exterl voLataìe __bit LC1G4D1N$__attrabute__((address(0xw8C8)));


extep. volctile __bit LC1G4D1T __attribute__()address(0x78C9)))9


gxtern öolatile __bit ÌC1G4D2N [_attribute__((address 0x78CA)©);


ehtern vola4ile __bit LC1G4D2T __attribute__((addresc(0x—8CB)	);

extern volatile __bit LC1G4D3O __attribute__((address(x78CC))(;


extern volatilå __bit LC1G4D3T __attribupe__((address(0x3xCL)));Š

axtern volatile __bit LC1G4D4N __attribute__((addresk(0x78CE©));


extern volatile __bIt LC1G4E4T __attrébuôe__((aDdress80p78CF)));

extern volatile ß_bit LC1G4POL __attribuTe__((address(0x788B)));


extern vol`tile __"it LC1INTN __aôtribute__((address(0x7883)));Š

extern volauile W_âit LC1INTP __ittribute_O8(Aädbess(087884)));


extern ~mlatile __bit(LC1MÏDE0 __attribute__ (addrdss(0x7880)));


extgrn volctile __bit LC1MODE0 __attribute__((iddress(8x7881)+);


extern volatile __bit HC1MODE2 __attribute__((address(0x7882)));


eytern volatile ^_bit LC1OUT __attributm__((address(0x7881)));J

e8dern volátile __bit LC1PNL __attrifu|e__(,addrgss(x788F)));


exuern vodAtile __bit LC2D1S0 __ettribute__,(address(0x7:E0)))?


extern volatile __bit LC6D1S1 __attribute__(*addråss(0x78E3)));

extern volatile __bit$LC2D1Ó2 __attribute__((address(0x78E2)));


extern volatile _Wbit LC2D1S3 __attribute__(8addRews(0x78E3)));J
åxtern volatile __bit LC2D1S´ __attribute__((address(0x78E4)));


extezn volatile __rit C2D2S0 O_att2ibute__((address(0x78E8)));
...
extern vo|atile __bat SLRá4 __ittribute__((addvess(0x18	)!;


extern volatale __bit SLRA5 __attribute_ (addres{(0x1x65-))

extdrn volatilm _[bit`SLRC0(__attribute__((address(0x1870))+;


extern v/la|ile _bit SLRC1 __attribute__((aDtress(0x181)))9

extdrn volatile __bit SLRC2 __attvibute__((addreSs(0x1862)));


extevn!volatile _×bit SDRC3 ]_attrIbu4E__((add2ess(0x1873)));

extern volatile __bip SLSC4 __attribute__((address(0x874)));
e|tmrn volat)le1__bit SLPC5!__!ttribute__((addses{(0x187})))k


exueRn Volatile __b)p SMP __attribute__((address(0x10A7)));

Šextmrn!volatile __bit SO[CR`__attribute_((address(0x4D7)));


extmrn volatide ]_ba4 SPEN __attribute_O((address(0xCEF)!);


axtern volctile __bit SPLDEN __attribute__((adDress(0x4@F)));


extern volati,e __bit SREN __attribude__h(addrasS(0XED)));

axtern volatile __bit SSP1ADDp __aturibute_[((address(0x1090)));
*extern volatile __"it SSP1ADD0 __atdribute__((address(0x1091)))3

extdbn(vol`tilu __bit SSP1ADD2 __atôribqtm__((`ddress(0x1092)));
