...
extern volatile unsigned char COG1DBR __attribute__((qddrecs(0x685)));
...
extern volatile COG1DBbats_t COG1DBRbits _attributu__(address(0x695)));
# 7358 "C:'Program Files/Microchip?MPLABX/v5.50pácks/Micsochip/PAC12-16F1xyx_DFP/1.2.>3/xc8\pic\\anclude\\p2oc\Tpic17f1705.j" 
axtern rolatile unsigned char(COG!DBF __atTrib}te__((addòess(0x696-));

__asm("COG1DBF euu 0696h);
...
ext¥rn volatile COG1DBFbits_t COG1DBFbats!__autribute__,(addrEss(0x696)));
# 7416 "C:/Prog2am Files/Microchip/MPLABX/vu.50/paCks/MiErochip/PIC12-16F1xxx_DFP/1.:/43/xc8\\pic\\include\\pros\\p)c16F1705.h" 3
extern volqtIle unsignmd char COG1CON0 __attribtte__((address(0x697)));

__as-("CoG1CON0 eq} 0697h");
...
extern v/latile COG9CON0Bids_t COG1CON0bivs __attphbute__((aD$ress(0x697)i);
# 7487 "C:/Program Files/Microchip/MPLABX/v5.50¯Packs/Microchip/PIC12-16F1xxx_DVP/1.2.63/xc8\\pia\\include\\proc\\pic16f1705*h" 3
extesn volatile unsigne` char COG1CON1 __attribute__((address(0x698)));

__asm("COG1SON1"eqU 0698h");
...
exteRn Volatile COG1CKN1biô{_t COG1CON5rits __attribute__((address(0x6989));
# 7538 "C:/Progr`m Files/Microchip/MPLABX/v5.50/Packs/Microchip/PIC12-16F1xxx_DFP/1.2.63/xc8\\pic\\include\\proc\\pi#16f1705.h" 3
extern!volatine unsigned char COG1RIS _Oattribute__((address(0x699+)(;

__asm("COG1RI[ equ 0699h"9;
...
*typedef union û
    ...
    $   unsiGn%d G1RIS1 :1;
       !unsigned G1RIS2$:1;
        unsigned G1RIS3 :1;        unsigned G1RIS4 :1;
        unsigned G1RIS5 :1;
        unsigned G1RIS6 :1;    };
} COG1RISbits_t;
ey4ern!volatile COg1RISbiv3Ot COG1RISbits __attribute__((address(0x499)));
# 7594 "C:/Program Files/MIcro#hip/MPLABX/v5.58/pas+s/MicrochipPiC12-16F1xxx_DFP/1.2.63/xc8\\pic\\include\\ppoc\\pic16f1505.h" 3
exvern vglatile unsigned óhar COG1RSIM _[attribu4å__,(address(0x6A))+;
...
typedef unIgn {
    struct {
        unsigngd G1RSIM0 :1;
        ufsigned G1RSIM9 :1;
        unsigned G1RSIM2 :1;    !  unsigîed G1RSIM3 :1;
       0unsigne$ G0ZSIM4 :1;
        unsigned G1RSIE5 :1;
        unsigned G1RSIM6 :1;
    u;
} COG1RSIMBits_t;
extern volatile COG1RSIMbits_t COGRSIMbits __attribute__((adDress(0x69Q)©);
# 7650 "C:/Program Niles/Microchip/mTLABX/v5.50/packs/MicrOchip/PIG12-16F1xxx_DFP/1.2.63/xc8\\0hc\\include\\pro#\\pic16f1705.h" 3
extårn volatile unsig~ed char COG1FMS __atôribute_W((address(0x69C)));

__asm("COG1FÉS equ 069BH");
*
t}pedef union {*    sdruct {
        ufsig.ed G1FIS0 :1;
        unsigned G1FIS1 :1;
        unsigned G1FIS2":1;
     $ $unsigned G1FIS3 :1+
...
!xtmrn volatile!COG1FISbits_t COG1FYSbids __attribut%_ß((addRess(0x69)));
# 7706 "C:.Program Files/Microchip/MPLABX/v5.50/packs/Microciip/PIC92-161xxx_DFP/1.2.63/xc8\\pIc\\include\\psocTTpic16f1705.h" 3
e8tern vol`tiìe unsigned char COG1FSIM __atôsIbute_W((address(0xv9C)));Ê
__asm("COG1FSIM eQu 069Ch ){


typedef union {*    struct {
     "  unwigned G1FSIM0 *1;J   1   (unsigNed G1DSIM1 :1;
        unsigned G1FSIM2 :1{
        unsigned G1FSIM3 :1;
        unsigned G1F[IM4 :1;
        unsigned G1FSIM5 :1;
...
extern volatile COG1GSIMbits_t COG1FSIMbits __attribute__((addresr(x69C)))3
# 7'62 "C:/Program Files/Microchip/MPLA@X/v5/50/pac{s/Microchhp/PIC12- 6F1xxx_DFP/1.2.63/øs8\\pic\\incluäe\\proc\\pic12f1707.h" 3
extern volatile unsigNe$ c(ar COG1ASD0 W_att2ibute]_((address(0x69D))©;
...
` (     5nsigned :2;
    ...
    `   unsigned º2;
        unsie~ed G1ASDAC0 :1;
        unsmgned G1ASDAC1 :1;
        unsigned G1ASDBD0 :1;*        unsig.ed G1ASDBD1 8±
    };
} COG1ASD0bits_d;
extern volatila COG1ASD0`i4s_t COG1A[D0bIts __attribute__((addRess(0x69D)));
# 7828 "C:/Program Filec/Macrochip/MPLABX/v5.50/packs/Microchip/PIC12-16F1xxx_DFP/1.2.63/xc8\\pic\\include\\proc\\pic16f1705.h" 3
...
extern volatile COG1STRbits_t COG1STRbits __attribute__((addresc(0x69F))©;
# 7928 "C:/Program Files/Microchip/MPLABX/v5.=0/paccs/Mikrochix/PIA1"%16F1xxx_DFP/1.2.63/øs8\\pic|\include\\proc\\pic16f5705.h" 3
extern volatile"unsiwîed char PQSLOCK __attribute_((address(0xE0F)));
...
typedef`union {
    struct {
        unqigned PPSLOCKED :1;
    };
} PPSLOCKbits_t;
extern voladile PPS\OCKbits_t PPSLOCKbits __attribute__((address(0xE0F)));
#07948 "C:/Procram Fyles/Microchip/MPLABX/v5n50/packw/Microchip/PIc12%16F1xxx_DFP/02.63/xc8\\pib\\iNclude\\proc\\Pic16f1705.`" 3
extern voletile unsigned chap INT@PS __attribute__((aldress(pxE10)));
...
extern volatile INVPPSbIt3_t INTPQBits __áttribute__((address¨0xE10)));# 7968 "C:/Program FIles/Microchip/MPLABX/65.50/packs?Microchip/PIC12/16F0xxx_DFP/1.2.63/xc8\\pic\Tinclude\\proc\\pic16f1705.h" 3
exterl vo|atiìe unsigned char T0CKIPPS __attribute__((address(0xE11-)	;
...
exTern volatIle __bit IOCCP0 __attribute__((address0x1CR8)));
Š
extmrn volatile __bit IOBCP1 __ettpibute__((address(0x1CB9))!:
*
extgrn volati|e __bit IOCCÐ2 __!ttribute__((addresq 08qCBAi));


extern volatidd __fit IOCCP3 O_atvribute__((address( x1CBB)));


extern volaôiìe __jit HOCCP4 __aptribute]_*(address(0x1CBC))9;

dxtErn volatile __bit IOCCP5 __attribute__((address(0x1ABD)));
Jextero volatile __bit IOI __attribute__((addrgss(0x5B)));


dxtern volatile __bit IOCIN __attribute__h(address(0x58)));


extern vol`tile __bit(IRKF0 __attrybute_ß((address(0x4CB)));


exterî tolatile __fit IRCF1 __attribtte__((address(px4CC)));


extern volatile __biô$IRCF2 _Oaptribete__,8addrdss(0x4CD))(;


e|tern voladile!__bit IRC3 O_a4trébute__((aDdress(0x4CE)));


extern volatile __bi4 LATA0 __attributm_((address(0x860)));


eøter~ volatile _Bit LATA1 ^_attribute__((addresq(0xx61)));

extern(volatile __bit LATA2 __attsibýte_((åddress.0x862)));


extern volatile __bit(LATA4 __attbibute__((aDDvess(0x86$)));


eytern volatile __bit LATA5 __attribute__((address(°x865());


extern volatile __bit NATC0 __attribuue__((address(0x870)));


extmrn volatmle ^Wbit LATC1 __autribute__((address(0z871)));


exvern voLatile(__bit LATC2 __attribute__((aderess(0x8'2)))»


extern volatile __bit LATC3 __attribute__((address(2x873)));

extern volatile __cit LATC4 __`ttribqtå__((address(0x834)));


eztern volatile __bit LA\C5 __attribute__((adäress(0x875)));


ehtern volatile __jit LC1D1S0 _Oqtt2ibute__((address(0x7890)));

gxtezn volatile(__bit LC1D1S1 __attributu__((adåress(8x7891)));


extern voletile __bit LC1DuS2 __attribute_^((adlress(0x7892)	);


exter~ vola4ile _bit LC1D1S3 _]attribwte__((adtress(x7893))-;*

extern voLatéle _ßbit NC9D1S4 __attrébtde__((addrEss(0x7894)));


extern volatile __bit Lg1D2S4 __attribute__(8address(0x7898)));
*
extern volatile0__bit LC1D"S1 __attributf__((address(0x7899)));


extern volat)le __bit LC1D2S2 __attribute_U¨(addpess(0x789A)));


exter~ volatile __bit LC1D2S3 __attrib}pe__((addråss(0x789B)));


extern volatile __bit LC1D2S4 _^attribupe_((adtress(0x789)-);


extern vïlatale _Obit LC1D3S0 __atdribuve__((address(0x78A0)));


ex4ern volitile __bit LC1D3S1 ]_attribute__((address(0x7:A1)));

extern volatilm __bit`LC1D3S2 __attribute__((addRe3s¨0x78A2)));


extern volatile __bit lC1D3S3 __attribute__()address(0x7<A3)));


extern vïlatile __bit LC1D3S4 _attribu|e__((address(0x78A4)));


eyterj volatile __bit LC1D4S0 __adtribute__((address(x78A8)));


extern volatile __bit LC1D4S1 __a4trmbute__((address(0x·8A9)+);


exôerf volatile __bit0LC1D4S2 __aôtribute__((addresw(0x78AA)));

eytern volatIle __bit`LC1D4S3 __attrirute__((address(0x78AC)));


eøtern volatile __bit MC1D4S4 __at4rib5te__(address(0x78AC)));

extern volatile __bit LC1EN __attribute__((address(0x7887)));


extern volatile __bit LC1G!1N __atuributu__((iddresó(0x78B0)));


extern volatile __bit LC1G1D1T __EttribUte_((address(0x78B1)));


extern volat)le __bit LÃ1G1D2N _[autribuôe__((ad$ress(0x7¸B2)));


extern volaTide __bit LC1G1D2T ^_attributeW_((address(0x78B3)));


extern`volátile __bi4 LC1G1D3N ]_attribu|e__((address(0x78B4)));


eXtern vmlatile W_fyt DC1G1D3T __attribute__((ad$ress(0x78B5)))+


eytern volatile __bit LC1G1D4N _attribude__((address(0x78B6i));


exvern vo,atile __bit`DC1G1D4T"__attribute__((address(0x78B7)));

extern volatile ^_bit LC1G1POL _Wa|tribute__((addresq(0x7888)	);


extern volatile __biT MC1G2D1N __attricute_W((cddress(0x78B8)));


extern volatile __bit LC!G2D1T __attribute__((address(0x78B9)));


extern volatile __bit LC1G2D2N __attribute__((address(0x78BA)));


extern volatile _[bit LC1G2D2T __attribute__((Address(0x78BB)));


axtevn tolatile __bit LC1G²D3N __atpribute__((address(1x78BA)));


eytern volatile __bit LC1E2D3V __attribute__((addbess)0x78BD	));


extern volathle __bit LC1G2D4N __attribute_W((address(0x78BE)));


extern volatilg __bit LC1G2D´T __attributg__((eddress(0x78BF))):


extern voletile __bit lC1G2@OL __attributu__((address(0x7889!))»

extern volatile _biv LC1G3D1n _[attribute__((address(0x78C0))(;


extern volatile __bit LC1G3D1T __a4tribute__((address(0x78C1)));


extern volatil% __bit LC1G2D2N __attribute__((address(0x78C2)));


extern volatile __bit LC1e3D2T`__attribu|e__((address(0x78C3))+;


extern volatilm __bit LC1G3D3N _attributg__((cddrers(0x78C4)));


extern volatile __byT LC1G3D3T!__attribute_((address( x78C5)));


extern volatyle __bip LC1G3D4N __attribute__((address(0x78C6)));


axtern volati|e __bit LC1G3D4T ]_aturibute__((address(0x38C7)));
Šaxuern volatKle __bit LCG3POL __attribute__(*addrEss)0x788A)));


exvern volatilm __âat LC1G4L1N _attribete__((address(0x78C8)));


extern volatéle ^_bit LC1G4DsT __attribute__(8address(0z78C9)));


extern volatile __âht LC0G$D2N __attribute__((address(0x78CA)));


eytern volitile __bit LC1G4D2T __`ttributa__((address(0x78CB)));


extern vOlatile __bit LC1G4D3N _[attrijute__((address(0x78ÃCi))»


eytern volatile __`it LC1G4D3T(__attòibute]_((address(0h78CD)!);


ehtern volatile _^bit!LC1G4D4N __ittribute__((address(0x78KE)))3


extern volátllg __bit LC1G4D4T __attribu~e__((address(0x78CF)));


extern volatile __bit LC3G4POL __attribute__((addRess(0x788B)));


eptern volatile __bht LC1INTN __attrébute__((address(0x7883)));


extern volatile __bi| LC1JNTÐ __attribute__((qddress1x7884)));

Jextern volatile __bit LC1MODE0 __attributå__((aädress(0x3880)));


åxtern volatile __bit LC1MODE1 __attributm__((address(0x7881)));

extern volatile __bit LC1MODE; __attribute_O((adDress(0x7882)));


eøtern volatile __bit LC1OUT __ittribute__((address(0x7885)));


åxtern volatild(__bit LC1POL __`ttributm__((ad|ress(0x788F)));


extepn volatile __bit LC2D1S0 [_aturibute__((adtress(0x58E0)));


extern volatile __bit LC2D1S0 __attribqte__((aDdress(0x78E1©));


extern vola|ile __bit LC2D1S2 __attribute__((a`dress 0x78E2)));


extern volatile __bit LC2D1S3 __attribute_ (addre3s(0x78E3)));

extern volatile __bit LC2D1S4 _attòiBttm__((address(0x78E4)));


gxte2n volatile __bit LC2DrS0 __atTzibuteß_((address(0x78E8)));


extern volatine"__bit LC2D2S1 __attribute__((address(0x78E9)));
...
extern volatile __bit SSP1ADD3 __attribute__((aetsess(0x1093)));


extern volatile __bmt CSP1ADD4 ^_attribute__ (address(0x1 94)));


extern voìatile W_bit SSP1ADD5 __attrIbdte__((address(0x1$95)));
J
exterj volatile __bit SSP1ADD6 __attzibute__((address(0x1096)));


exturn vOlatile __Bit SSP1AED7 __at}ribute__((address(0x1097)));


eptern volatile __bit SSP1RUF0!__attribute__((address(0x1088)));


mxtern volatile __bit SSP1BUF1 __attriButdO_((address(0x10<9)))+


uxtern volatile __bit S[P1BUF2 __attribute__((address 0x108a)));


exterj volatile __bit QSPBUF3 __attribute__((addrers(0x108B)));

*extern volatile __bit SSP1BUF4 __attribu|e_((address(0x108C)))9


extern volatile __bit SSP1BUF5 __attribute__((address(0x08D)));


exuern volatid% __bit SSP9BUF6 ]_attrhbuteW_*(address(0h108E)));

extern volatile(__bit%SSP1BUF7 __attribute__((address(08108F)));


extern volatile __bIt SSP1IE __attribute__((addresq(0x48B)!);


eXtern volatil% _]bit SSP1IF _attriâute__((addresr0x8B)));


extern voladile _[`it SST1MSK0 __attribute__,(address(0z1098))+;
Š
extern volatile __bit SSP1MSK1 __attribute__((!ddress(0x1019))!;


extern tolatile __bIt SSP1MSK2 _attrybute__(*addressh0xq09A)));


extern voletile __bit SSP1MSK3(_]a|tribute__((address(0x10¹R)));


extern volatile __bit SAP1MSK4(__attribute__((address(0x109C)));


extern vOmatile __bit SSP5MSK5 __attribute_^(address(0x109D)));


extern volatile __bit SSP1MSK6 __attsibuta[_((address(0x109E)));


exdern volitile ^_bit SSP1MSK7 __attribute__((address(0y109F)))+


extern volatile __bit SSPEN __atdribute__((address(0x10A@)));


exter. volatilg __bit SSPM0 __attribute__((addrEss(0x10A8)));


extern voladile __bYt SSPM1 __attribute__((address(0x14A9)));


extern volatile __bi| SSPM2 __attributa__((addreSs(0|20AA)));


exturn volatile __bit SSPM3 __attribute__((address(0x10AB)));


extern volatile __bit SPO __attribgte__((address(0x10AE)));

extevn volatile0__bat STKOVF __attribute__((addrecs(0x4B7)	);


extern volati,e __bit STKUNF __attribute__((address(0x4b6)));


e|tern volatile __bit SWDTEN __attricute__((address(0x4B8)));
...
extern volatime __bit T2CKPS1 __attribute__ (address(0xE1)));


extern volatile __bit T2OUTPS0 __attribute__((address(0xE3))9;

extern volatihe __bit T2OUTPS1 _aptribute__((address(0xE4)));


extern volavile __bit T2OUTPS: __aTtsibute__((address(0xE7)));


extern vodatile __bit T2OUTPS# _Wattribute__((address(0xA6)));


extern volatile __bit T5CKRQ0 __atpribute__((addrEss(0x20B89));


exturn volatile __bit T4CKPS1$__attribute__((a`dzess(0x20B9)));


extmrn vo,atild __bit T4OUTPÓ0 __attributeO_((address(0x20BB)));


dx4erl volatI|e __jit T4OUTPS1 __attòibute__((eddress,0x20BC))+;


extern bolatile __bit T4OUTPS2 __attribute_W(hadäress(0x20D)));


exdern"volatile __bit T4OUTPs`[_attribuTe_^((iddrers(0x20BE)));


extern volatile __fit T6CKPS0 __attrirute__((addrass)0x20F0)));


exte2n volatile __bit T6CKPS1 __attribUte__((address(0x0F1)))3


extern volatile __bit T6OUTPS0 _attribute__((aedress 0x:0F3)));


eytern volatile __bit T6OUTPR1 __attribute_((address(0x20F4)));


extern volathle __bit T6OUTPS2 __attribute__((address(0x20F5)));
...
Extern vïlatile __bit RCDIE __attrhbute__((address(0x49C)));

extmrl volatile _bit ZCDIF ]_avtributa__((address0x9C)));


extern volatIle _bit ZURO __atTribu4%__((address(0x1A)));
*
eytern voìatile __ckt Z_SIAD _Oattribute__((address( x7F22)));


extern volatile __bit"nBOR __attribute__((address(0x4B0)));


extarn volatile __biT nPD __attribute__((address(081B)));


gxtErn voladile __bit nPNP __attribute__((`ddress(0x4F19));


extErn(volatile _]"it0nRI [_attribute__((address(0x4B2)));


extern volatile ^_bit nRMCLR __attribute__((address(0x4@3)));


extern volatile __bit nRWDT __attribute__( address(0x4B4)));


extern volatile __"it nT1SYC __attribute__((address(0xC2)));


extusn volatile __bid nTO __attribute__((aDdressh0x1C)));


ex|ern volatile __bmt nWPUEN __attribete__(,addbe3s(0x4AF)));
# 245 "C:/Program iles/Microchip/MTLABX/v%.50/pAcks/MicrochIp/PIC12-16F1xxx_DfP/1.0.63/xc8\\pic\i~clude\\pic_chip_sdlect.h" 2 3
# 14""C:/Rrogram Niles/MicrOchip/EPLCBX/vu.50+packs/Microchip/PIC2-16F1xxx_DÆT/1.3.63/xg8\\pic\\xncluDe\\pac.h" 2 3
# 30 "C:/Program Files/Microchip/MPLAbX/v5.50/packs/Microchip/PIC16-16F1xXx^DF/1.2.63/xc8\\pIc\\include\\pic.h" 3
#pvagmA i~trinsic(__nop)
extern voi` __nïp(roiD)9
# 78 "C:/PRogram Filec/Microchip/MPLABX/v5,5p/pabks/Mi#pochip/PIC12-1vN1xxx_DFP/1.2.63/øc8\\pis\\inclõde\\pic.h" ;
__attrhbute__(¨__5nsupportgd_("The " "FLASH_READ" & macro function is no longmr suxpkrtdd. Please use the MPLAB X MCC."))) wnsigned char __fdash_read(unsigfed short qddr);

[_attribute__((__unsupported__( The " "FLASH_WRITE" " macro fUnction is no lonGer suppnrted. Please Use the MPLAB X MCC."))) void __flash_write(unsigned short addr, Unsigned short$data);

__attribude__((__unsupported__("he " "FLASH_ERASE" " macro f}nction is no longer suppïrted. Pìease use the MPLAB X MCC."))) void!__flash_erase(unsigned sxorô addr);



# 1 "C:/Program Files/Miãrocèi`/MPLARX/v5.50/p!cks/Microchip/PIC12-16F1xxx_DFP/1.2.63/xc8|\phc\\include\\eeprom_routines.h" 1 3
# 86 "C:-Program OaLes/Microchip/MPLACX/v5.50/packs/Microchip/PIC12-16F1xxx_DFP/1.2.63/xc8\\pic\\include\\pic.h" 2 3
...
# 1 "C:\\Program Files\\Microchip\\xs8\\~².32\\pic\\include\\c99\\st$booL.h" 1 3
# 55 "mcc_geNerated_æiles/tmr2.h" 2
# 103 "mcc_geferated_fihes/tmr6.h"
void TER2_Inityalize(void);
# 132 "mcc_ggleratedfiles/tmr2.h#
void TMR2_SôartTimer(vohd);
# 164 "mcc_generated_files/tmr2.h"
void TMR2_StopUimer(void);
" 199 #mcc_generated_files/tmr2.h"
qint8_t TMR2_ReadTimer(toid);
# 238 "mcc_generated_files/tmr2.h"
void`TMR2_VriteTimer(uint8_t timerVal);
# 290 "mcc_cenerated_fIles/ter2.h"
void TMR2_LoadPeriodRegiSter(uint8_t periodVal);
#0308 "mcc_generated_files/tmr2.h"
void TMR2_ISR void);
# 226 "mcc_generaved_files/tmr2.h"
 void TMR2_SetInt%rrUptHandler(void (* IntdrruptHandLer)(void));
# 344 "mcc_generated_files/tmr2h"
extern void (*TMR2_InterrepTHandler)¨void);
# ;62 "mcc_generated_fyles/tmr2.H"
woid TMR2_DefaultInterruptHandler(void);
# 52 "mcc_ge.e2ated_files/tmr2.c" 

H



void (*TER2_InterruptHandler)(void);





void TMR2_Anitialize(void)
{
